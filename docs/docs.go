...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.PaginatedResponse-github_com_eenemeene_kitamanager-go_internal_models_CostResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.CostCreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.CostResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.CostDetailResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.CostUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/organizations/{orgId}/costs/{id}/entries": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.PaginatedResponse-github_com_eenemeene_kitamanager-go_internal_models_CostEntryResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.CostEntryCreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.CostEntryResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/organizations/{orgId}/costs/{id}/entries/{entryId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.CostEntryUpdateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_eenemeene_kitamanager-go_internal_models.CostDetailResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "github_com_eenemeene_kitamanager-go_internal_models.CostEntryCreateRequest": {
            "type": "object",
            "required": [
                "amount_cents",
                "from"
        ...
        "github_com_eenemeene_kitamanager-go_internal_models.CostEntryResponse": {
            "type": "object",
            "properties": {
                "amount_cents": {
                    "type": "integer",
        ...
        "github_com_eenemeene_kitamanager-go_internal_models.CostEntryUpdateRequest": {
            "type": "object",
            "required": [
                "amount_cents",
                "from"
        ...
        "github_com_eenemeene_kitamanager-go_internal_models.CostResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "github_com_eenemeene_kitamanager-go_internal_models.CostUpdateRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "github_com_eenemeene_kitamanager-go_internal_models.PaginatedResponse-github_com_eenemeene_kitamanager-go_internal_models_CostEntryResponse": {
            "type": "object",
            "properties": {
                "_links": {
                    "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.PaginationLinks"
        ...
        "github_com_eenemeene_kitamanager-go_internal_models.PaginatedResponse-github_com_eenemeene_kitamanager-go_internal_models_CostResponse": {
            "type": "object",
            "properties": {
                "_links": {
                    "$ref": "#/definitions/github_com_eenemeene_kitamanager-go_internal_models.PaginationLinks"
